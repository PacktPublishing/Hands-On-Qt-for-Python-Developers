...
UQml.Window {                                // Window object, parent of the
    ...
    Uqmls.URect {                            // Rectangle 1.
        ...
        if (ucolor=="#000F1D") {             // Using if/else construction to
            return "#000F1F";                // realize some functionality.
            } else {                         // Function will return white
                return "#000F1D";            // color, if rectangle 1 is not
            };                               // white, and return shuttle 
        }                                    // color if white. 
    ...
    Uqmls.UItem {                            // of the rect 1. Adding of the
        visible: true                        // items to the application.
        width: rect1.width                   // Width and height will be
        height: parent.height - rect1.height // related to the rectangle 1
        y: rect1.height                      // and paraent item (Window).
    }                                        // With position after rect1.
